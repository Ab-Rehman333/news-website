        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    ?>
                    <h2 class="page-heading">Search : <?= $search_id ?></h2>
                    <?php
                    ...
                    if (mysqli_num_rows($result_two) > 0) :
                        ...
                        if ($page > 1) {
                            echo '<li><a  href="author.php?search=' . $search_id . 'page=' . ($page - 1) . ' ">Pre</a></li>';
                        }
                        ...
                        for ($i = 1; $i <= $total_pages; $i++) {
                            ...
                            echo '<li class="' . $active . '"><a href="author.php?search=' . $search_id . '&page=' . $i . ' " > ' . $i . '</a></li>';
                        }
                        if ($total_pages > $page) {  // 3 > 2
                            echo '<li><a  href="author.php?search=' . $search_id . 'page=' . ($page + 1) . ' ">Next</a></li>';
                        }
